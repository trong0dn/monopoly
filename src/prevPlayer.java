/*
Going to comment this out for now since we want to just do function calls for the player class.

making it go from...

            regular java class -> java interface;

we would proceed to add function calls like
- String name();
- int getBalance();
